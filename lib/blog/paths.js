    ...
    var self = {
        ...
        get: function(parameter, callback) {
            if (parameter.id in parameters) {
                callback(null, {matched: true, value: parameters[parameter.id]});
        ...
        match: function(components, parameterValues, callback) {
            parameter.match(components.peek(), function(err, matchResult) {
                if (err) {
                    ...
                    exports.firstOf.apply(undefined, subMatchers).match(components, parameterValues, callback);
                } else {
                    callback(null, {matched: false});
                }
            });
...
exports.parameters.composite = function() {
