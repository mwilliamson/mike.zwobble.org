...
var postQuery = function(postCollection, initialPostConditions, postMapFunction) {
    var year, month, slug;
...
var postRepository = function(mongoDb, initialPostConditions, postMapFunction, callback) {
    mongoDb.collection("posts", function(err, postCollection) {
        if (err) {
            ...
            callback(null, {
                posts: function() {
                    return postQuery(postCollection, initialPostConditions, postMapFunction);
                }
            })
        }
    });
