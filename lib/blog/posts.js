...
var postQuery = function(postCollection, initialPostConditions, listOptions) {
    ...
    var self = {
        ...
        list: function(range, callback) {
            ...
            postCollection.find(buildConditions(), {oldRevisions: 0}, listOptions).toArray(callback);
        },
...
var postRepository = function(mongoDb, initialPostConditions, listOptions, callback) {
    mongoDb.collection("posts", function(err, postCollection) {
        if (err) {
            ...
            callback(null, {
                ...
                createPost: function(title, bodyHtml, callback) {
                    postCollection.save({
                        isPublished: false,
                        oldRevisions: [],
                        latestRevision: {
                ...
                updatePost: function(post, title, bodyHtml, callback) {
