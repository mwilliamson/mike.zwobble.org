...
injector.bind("controllers.editPost").toSyncProvider(require("./controllers/editPost"), "content", "adminPostRepository", "postParameters");
injector.bind("controllers.newPost").toSyncProvider(require("./controllers/newPost"), "content", "adminPostRepository", "postParameters");
