...
injector.bind("controllers.monthArchive").toSyncProvider(archiveControllers.month, "postRepository");
injector.bind("controllers.yearArchive").toSyncProvider(archiveControllers.year, "postRepository");
